    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('guest', 'Guest'), ('base', 'Base'), ('artist', 'Artista'), ('verified_artist', 'Artista Verificato'), ('admin', 'Admin'), ('promoter', 'Promoter')], default='guest', max_length=20)),
